...
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/huawei/u8850/releasetools/triumph_img_from_target_files
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/huawei/u8850/releasetools/triumph_ota_from_target_files
...
TARGET_RECOVERY_INITRC := device/huawei/u8850/recovery/init.rc
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_USES_MMCUTILS := true
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/huawei/u8850/recovery/recovery_ui.c
BOARD_CUSTOM_GRAPHICS := ../../../device/huawei/u8850/recovery/minui/graphics.c
...
TARGET_KERNEL_CONFIG := def_config
